...
def main():
    ...
    arg_parser.add_argument('-r', '--orm-rules-path',
                            type=str,
                            default="namespaces/**/*.yml",
                            help="Glob specifying ORM rule files.")
    arg_parser.add_argument('-G', '--globals-path',
                            type=str,
                            default=None,
                            help="Path to ORM global settings file.")
    arg_parser.add_argument('--cache-path',
                            type=str,
                            default=None,
    ...
    arg_parser.add_argument("-c", "--check",
                            ...
                            action='store_true',
                            default=False)
    arg_parser.add_argument("-C", "--no-check",
                            help="Do not validate rules.",
                            action='store_true',
                            default=False)
    arg_parser.add_argument("-t", "--test-target",
                            help="Run tests against the provided URL.",
                            metavar="URL",
                            type=str,
                            default=None)
    arg_parser.add_argument("-k", "--test-target-insecure",
    ...
    if not args.no_check:
        ...
        if not validator.validate_rule_files(yml_files=yml_files,
    ...
    parsed_rules = parser.parse_rules(yml_files=yml_files,
                                      defaults=defaults)
    ...
    render_varnish = RenderVarnish(rule_docs=domain_rules,
